...
// import { Table, Card, Typography, Tag, Button, Input, Modal } from "antd";
...
//           dataSource={
//             stock
//               ? Object.entries(stock).map(([item, values]) => ({
//                   key: item,
//                   item,
...
//                 type="number"
//                 min="0"
//                 value={updateStockInput[item] || stock[item]?.available || 0}
